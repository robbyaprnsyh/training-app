        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row mb-1">
                    <label for="name" class="col-sm-3 col-form-label">{{ __('Label') }}<sup class="text-danger">*</sup></label>
                    <div class="col-sm-9">
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-sm-8">
                        <div
                            ...
                            <input type="checkbox" id="custom_url" name="custom_url" value="1"
                                class="custom-control-input form-check-input" data-text-on="{{ __('Ya') }}"
                ...
                <div class="form-group row mb-1 box-routes">
                    <label for="route" class="col-sm-4 col-form-label">{{ __('Route') }}<sup class="text-danger">*</sup></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row mb-1 box-custom">
                    <label for="url" class="col-sm-4 col-form-label">{{ __('URL') }}<sup class="text-danger">*</sup></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row mb-1 d-none">
                    ...
                    <div class="col-sm-8">
                        <div
                            class="cb-dynamic-label custom-control custom-toggle custom-toggle-sm mb-1 mt-1 form-check form-switch form-check form-check-inline">
                            <input type="checkbox" id="data_authority" name="data_authority" value="1"
