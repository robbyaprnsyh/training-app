...
@section('content')
    ...
    <div class="modal-body pb-2">
        <div class="form-group row p-0 mb-1">
            <label for="name" class="col-sm-3 col-form-label">{{ __('Nama Unit Kerja') }}<sup
        ...
        <div class="form-group row p-0 mb-1">
            <label for="tipe_unit_kerja_id" class="col-sm-3 col-form-label">{{ __('Tipe') }}<sup
                    class="text-danger">*</sup></label>
            <div class="col-sm-9">
        ...
        <div class="form-group row p-0 mb-1 unit" style="display: none;">
            <label for="tipe_unit_kerja" class="col-sm-3 col-form-label">{{ __('Sub Unit Kerja') }}<sup
                    class="text-danger">*</sup></label>
            <div class="col-sm-9">
                <div class="mt-0">
