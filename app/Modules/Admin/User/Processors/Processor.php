        ...
        try {
            switch ($operation_type) {
                ...
                case 'change-password':
                    $this->output = $this->service->changePassword($data);
                    break;
                case 'reset-password':
                    $this->output = $this->service->resetPassword($data);
                    break;
                case 'release':
                    $this->output = $this->service->release($data);
                    break;
                case 'import-user':
                    $this->output = $this->service->importUser($data);
                    break;
            }
