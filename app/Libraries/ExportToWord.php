...
class ExportToWord {
	...
	private static $imgRef = 'public/assets/images/';				// path to the images directory in 'ref' format
	private static $imgDir = 'public/assets/images/';					// path to the images directory in absolute format
