...
use App\Modules\Tools\Appconfig\Repository;
...
class Controller extends BaseModule
{
    ...
    public function index()
    {
        ...
        $count = Service::count();
        return $this->serveView(['count' => $count]);
    }
    ...
    public function unlockconfig(Request $request)
    {
        $result = $this->repo->startProcess('unlockconfig', $request);
        return $this->serveJSON($result);
    }
}
